...
const Startpage = () => {
  ...
  const loginForm = () => {
    return (
      <form className="spform">
        ...
        ></input>
        <br></br>
        <button className="spform-button" onClick={(e) => login(e)}>
          Login
        </button>
      </form>
    );
  ...
  const registerLink = () => {
    return (
      <p className="sp-register-link">
        Don't have an account? Register{" "}
        <a href="" onClick={(e) => showRegisterForm(e)}>
          here.
        </a>
      </p>
    );
    ...
    return (
      <form className="spform">
        ...
        <input
          ...
          onChange={(e) => handleRegisterFieldChange(e)}
          placeholder="enter your email..."
        ></input>
        <br></br>
        <label>Password:</label>
        ...
        ></input>
        <br></br>
        <button className="spform-button" onClick={(e) => register(e)}>
          Register
        </button>
      </form>
    );
  ...
  return (
    <div className="startpage">
      ...
      {registerEnabled ? registerForm() : null}
